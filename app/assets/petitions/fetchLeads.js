...
const fetchLeads = (successResponse, backendURLBase, endpoints, clientId, dataUser, emailData, allDataIn) =>{
    ...
    fetchData('POST', backendURLBase, endpoints.toSaveLeads, clientId,`&firstName=${dataUser.userName ? dataUser.userName:''}&postalcode=${dataUser.zipCode ? dataUser.zipCode:"N/A"}&emailData=${dataUser.emailUser}&representative=${allDataIn}&emailMessage=${dataUser.text}&subject=${dataUser.subject}&sended=${successResponse}`)
